...
namespace ImGui
{
    ...
    IMGUI_API bool          InputMultilineText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, void (*callback)(ImGuiTextEditCallbackData*) = NULL, void* user_data = NULL);
